...
public class CalendarEx {
	...
	public static void main(String[] args) {
		...
		// 켈린더 상수로 날짜의 정보를 받을 수 있음
		int year = now.get(Calendar.YEAR);  // 연 정보 get
		int month = now.get(Calendar.MONTH) + 1; // 월 정보 get
		...
		System.out.printf("10년뒤: %d년 %d월 %d일 %n", future.get(Calendar.YEAR), future.get(Calendar.MONTH)+1, future.get(Calendar.DATE));
