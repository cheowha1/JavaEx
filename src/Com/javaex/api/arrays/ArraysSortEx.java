...
//		basicSortDesTest();  // 기본 타입 내림차순 정렬
	...
	private static void basicSortTest() {
		...
		Arrays.sort(scores);
		System.out.println("오름 차순 정열:" +
						Arrays.toString(scores));
	}
	
	private static void basicSortDesTest() {
...
//		Arrays.sort(members);
//		System.out.println("오름 차순 정렬:" + Arrays.toString(members));
		Arrays.sort(members, Collections.reverseOrder());
		System.out.println("내림 차순 정렬:" + Arrays.toString(members));
	}
}
